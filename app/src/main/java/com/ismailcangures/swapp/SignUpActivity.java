    ...
    private void validatePhoneNumber(String phoneNumber, String username, String password) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    Toast.makeText(SignUpActivity.this, "Your phone number is already in use. Please login.", Toast.LENGTH_SHORT).show();
                }

                else if(snapshot.child("Users").child(username).exists())
                {
                    Toast.makeText(SignUpActivity.this, "Username is already in use. Please pick another username.", Toast.LENGTH_SHORT).show();
                }
                    ...
                    RootRef.child("Users").child(phoneNumber).updateChildren(userDataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    {
                                        Toast.makeText(SignUpActivity.this,"You registered succesfully!",Toast.LENGTH_SHORT).show();
                                        Intent i = new Intent(SignUpActivity.this,ProfileFill.class);
                                        startActivity(i);
                                        finish();
                                    }
                                    else
                                    {
                                        Toast.makeText(SignUpActivity.this,"Problem been occured while registering. Please try again.",Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
